#!/usr/bin/env bash
#
# Run NEK5000 parallel multi-agent tests with MPMD coupling.
#
# Usage:
#     ./run_parallel_docker.sh                    # Test only
#     ./run_parallel_docker.sh train              # Train SB3 agent
...
echo "=== NEK5000 Parallel Multi-Agent (DIY Wrapper) ==="
echo "Mode: $MODE"
...
if [ "$MODE" == "train" ]; then
    echo "=== Training SB3 Agent (DIY Centralized Wrapper) ==="
    ...
    echo "=== Testing Parallel Environment ==="
