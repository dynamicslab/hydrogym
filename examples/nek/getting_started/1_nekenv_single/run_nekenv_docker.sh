#!/usr/bin/env bash
#
# Run NEK5000 single-agent tests with MPMD coupling.
#
# Usage:
#     ./run_nekenv_docker.sh                    # Test only
#     ./run_nekenv_docker.sh train              # Train SB3 agent
