...
def ppo(
    ...
    def update():
        ...
        print(f'Mean return: {torch.mean(data["ret"])}')
        ...
        kl = pi_info["kl"]
        print(f"LossPi: {pi_l_old}")
        print(f"LossV: {v_l_old}")
        # print(f'DeltaLossPi: {loss_pi.item() - pi_l_old}')
        # print(f'DeltaLossV: {loss_v.item() - v_l_old}')
