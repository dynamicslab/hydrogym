...
if __name__ == "__main__":
    ...
    axs.plot(domain, y_domain, "s-", markersize=10, c=colorplate.red, label="Element Nodes")
    axs.plot(gll_nodes, y_gll, "o", markersize=8, c=colorplate.blue, label="GLL Nodes")
    axs.grid()
    axs.set_ylabel("Value")
    axs.set_xlabel("Grids")
    axs.set_title(f"Polynomial Order = {N}\n Domain [{domain.min()}, {domain.max()}]")
