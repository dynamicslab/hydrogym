...
Point(10) = { -0.5, 0.1, 0, 1/n};
Point(11) = {  0.5, 0.1-h_s, 0, 1/n};
Point(12) = {  0.5, 0.1, 0, 1/n};
Point(13) = {  0.5, 0.1-h_s, 0, 1/n};
Point(14) = {  0.0, 0.1-h_s, 0, 1/n};

Point(15) = {-L_in, 0.1, 0, 1/n2};
Point(16) = { -1.0, 0.1, 0, 1/n2};
Point(17) = {  2.0, 0.1, 0, 1/n2};
Point(18) = {  2.0, 0.1-h_s, 0, 1/n2};
Point(19) = {L_out, 0.1-h_s, 0, 1/n2};

Point(20) = {-L_in, h_in-0.1, 0, 1/n2};
...
//+
Physical Curve("Freestream", 3) = {4, 28};
//+
