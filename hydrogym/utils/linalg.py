...
from .modred_interface import vec_handle_mean, Snapshot, PODHandles, VectorSpaceHandles
...
def pod(flow: FlowConfig,
    ...
    if remove_mean:
        ...
        snapshot_handles = [Snapshot(snap.filename, base_vec_handle=base_vec_handle)
