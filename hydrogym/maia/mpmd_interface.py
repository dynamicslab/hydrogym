...
class MaiaInterface:
    ...
    def _comm_send_int(self, name: str, data: Union[List[int], np.ndarray]) -> None:
        """
    ...
    def setControlProperties(self, control_actions: Union[List, np.ndarray]) -> None:
        """
    ...
    def getProbeData(self, probe_point_coords: Union[List, np.ndarray]) -> np.ndarray:
        """
