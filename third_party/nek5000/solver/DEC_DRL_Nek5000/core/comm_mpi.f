...
c      endif
      ...
      ! YW Modified here: Aviod the incompatable MPI Tags, and cancel the sanity check 
      call mpi_attr_get(intracomm,MPI_TAG_UB,nval,flag,ierr)

      ! The follows are the original implementation
