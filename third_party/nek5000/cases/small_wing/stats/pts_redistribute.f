...
cc YW: Debugging here Nov.13 2023
...
cc YW:
      ! write(*,*) "YW: nptimb, nptmax", nptimb, nptmax
      ierr = 0
      ! write(*,*) "YW: nptva1, LHIS", nptav1, LHIS
     
      if (nptav1.gt.LHIS) ierr = 1
      ! write(*,*) "YW: ierr before iglsum", ierr
     ...
     $        'Error: pts_map_all; wrong nptav'
        call exitt
            ...
            ! write(6,*) "YW: 'Error: Unexpected condition"  
...
!     Is there more processors than the array size
      ...
      ! write(*,*) "YW: nloop, nloopmod", nloop, nloopmod
...
cc YW: Try not use syncronisation 
      !    call nekgsync()
...
c-----------------------------------------------------------------------
!     redistibute points between processors
      subroutine pts_map_ctl(mid,lpts,npts,npoints,nptimb)
